...
export default function Wraith({ ...props }) {
  ...
  useEffect(() => {
  console.log('---',lightRef?.current?.target.position.set())
  lightRef?.current?.target.position.set(lightPoint.current.position)
  // lightRef?.current?.target.position.x = 55;
  // lightRef?.current?.target.y = 200;
  // lightRef?.current?.target.z = -50;
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh position={[50, 30, 260]} ref={lightPoint}>
